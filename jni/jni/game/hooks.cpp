...
{
    if (CTimer_StartUserPause) CTimer_StartUserPause();
...
{
    if (CTimer_EndUserPause) CTimer_EndUserPause();
...
void CalculateAspectRatio_hook()
{
    ...
    if(ms_fAspectRatio) *ms_fAspectRatio = 1.3333333f;
}
...
void InstallSAMPHooks()
{
    ...
    // Aspect Ratio Fix
    ARMHook::installHook(g_libGTASA + 0x5A61CC, (uintptr_t)CalculateAspectRatio_hook, (uintptr_t*)&CalculateAspectRatio_Original);
